...
function ShortcutCollector() {
  ...
  useEffect(() => {
    if (!playerElement || !playerElement.provider) {
      return
    } // If there's no provider, there's also no video.
    ...
    function onKeyPress(e: any) {
      if (preventOverrideOnElements.includes(document.activeElement.tagName)) {
        return
      } // prevents overriding input on input elements
