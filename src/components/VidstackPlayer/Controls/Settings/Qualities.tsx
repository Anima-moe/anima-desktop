    ...
    >
      ...
      <div className="max-h-[calc(100vh-16rem)] overflow-scroll">
        <div
          ...
          onClick={() => {
            if (streamConfig.streamHeight === 0) return
        ...
        {streamConfig.streamHeights.map((quality, index) => {
          const classNames = clsx({
            ...
            'hover:bg-accent hover:text-primary': streamConfig.subtitleLocale !== quality.height,
          })
          ...
          return (
            <div
              ...
              onClick={() => {
                if (streamConfig.subtitleLocale === quality.height) return
                setStreamConfig({
                  ...streamConfig,
